...
LOG_FILE_FRAMEWORK="$LOG_DIR/test_build.log"
...
echo -e "\n\n${GREEN}BUILD TEST FRAMEWORK${NC}\n\n"

schemes=("TestSDK" "TestSDKPrebid" "TestSDKGoogleMobileAds")
...
do
	...
	xcodebuild -create-xcframework \
	    ...
	    -output "$OUTPUT_DIR/${schemes[$n]}.xcframework"
